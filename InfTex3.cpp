...
// InfTex3.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CInfTex3App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CInfTex3App

CInfTex3App::CInfTex3App()
{
...
// Единственный объект CInfTex3App

CInfTex3App theApp;


// Инициализация CInfTex3App

BOOL CInfTex3App::InitInstance()
{
